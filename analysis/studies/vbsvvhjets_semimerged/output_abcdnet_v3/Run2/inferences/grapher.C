...
{
	std::string outputFilename = "output_mjj1150_abdcnet976.csv";
...
//  combining the two vqq ak4 jets four vectors
	...
	for (int ifile = 0; ifile < input_files.size(); ifile++)
	{
		...
		{
			t1->GetEntry(i1);
			bool conditionA = abcdnet_score > 0.976 && abs_deta_jj > 6 && M_jj > 1150 ;
			bool conditionB = abcdnet_score > 0.976 && !(abs_deta_jj > 6 && M_jj > 1150);
			bool conditionC = !(abcdnet_score > 0.976) && (abs_deta_jj > 6 && M_jj > 1150);
			bool conditionD = !(abcdnet_score > 0.976) && !(abs_deta_jj > 6 && M_jj > 1150 ) ;
            ...
            if (abs_deta_jj > 6)  // Example fixed cut for abcdnet_score plot
                   hist_abcdnet_fixedEta->Fill(abcdnet_score, weight_of_eachevent);

               if (abcdnet_score > 0.976)  // Example fixed cut for abs_deta_jj plot
